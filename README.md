...
This pipeline will be tested on Drug-Target Interaction (DTI) data as a link prediction task. You can find the scripts of this test in the [Example](#example) section.
...
## Input files formats
The input file format for [Network Embedding](#2-network-embedding) is a space-delimited edge list file. If the edge list file is ready in [this](./output/edgelist/edgelist_drug_drug.txt) format, users can start from the [Network Embedding](#2-network-embedding) step. If the networks are in adjacency matrix format, this pipeline provides the command line to convert adjacency matrices to edge lists in section [1.1. Convert Adjacency Matrix to Edge List](#11-convert-adjacency-matrix-to-edge-list). Adjacency matrices should contain column names and row names, and the format should be space-delimited. Click [here](./data/mat_drug_drug_top.txt) to see sample adjacency matrix.
...
&emsp; &emsp; &emsp; Click [here](./data/mat_drug_drug_top.txt) to see a sample file.
...
&emsp; &emsp; &emsp; **output** &ensp; The filepath for the output edge list file\
&emsp; &emsp; &emsp; The file will be saved as a space-delimited file. Click [here](./output/edgelist/edgelist_drug_drug.txt) to see a sample edge list file.
...
&emsp; &emsp; &emsp; This file should be a space-delimited edge list file. Click [here](./output/edgelist/edgelist_drug_drug_top.txt) to see a sample input file.


&emsp; &emsp; &emsp; **input2** &ensp; The filepath of second edge list file\
&emsp; &emsp; &emsp; This file should be a space-delimited edge list file. Click [here](./output/edgelist/edgelist_drug_disease_top.txt) to see a sample input file.

&emsp; &emsp; &emsp; **rmduplicate** &ensp; Removes duplicated edges

&emsp; &emsp; &emsp; **output** &ensp; The filepath for the output combined edge list file\
&emsp; &emsp; &emsp; The file will be saved as a space-delimited file. Click [here](./output/edgelist/edgelist_hetero_drugs_top.txt) to see a sample output file.
...
&emsp; &emsp; &emsp; This file should be an space-delimited edge list. Click [here](./output/edgelist/edgelist_drug_drug.txt) to see a sample input file.
...
&emsp; &emsp; &emsp; The file saves as a space-delimited file. Click [here](./output/embedding/deepwalk_20_drug.txt) to see a sample output file.
...
&emsp; &emsp; &emsp; Choices are:\
&emsp; &emsp; &emsp; &emsp; early: Merging all embedding results before passing to the prediction model\
...
&emsp; &emsp; &emsp; When late fusion is applied, the entity1-embeddings and entity2-embeddings should have the same length with the same order of embedding methods.

&emsp; &emsp; &emsp; **entity2-embeddings** &ensp; filepaths of the embeddings containing the entities of the **second** column (entity2) in the annotation file\
&emsp; &emsp; &emsp; The file paths should be given in this format: '[["deepwalk_protein.txt"](./output/embedding/deepwalk_20_protein.txt), ["gf_protein.txt"](./output/embedding/gf_20_protein.txt)]'.\
&emsp; &emsp; &emsp; When late fusion is applied, the entity1-embeddings and entity2-embeddings should have same length with the same order of embedding methods.
...
&emsp; &emsp; &emsp; **cv-shuffle** &ensp; Whether to shuffle each class samples before splitting into batches\
&emsp; &emsp; &emsp; This argument is used when the *cv-type* is either 'kfold' or 'stratified'.
...
&emsp; &emsp; &emsp; 'SMOTE' is the oversampling method.\
